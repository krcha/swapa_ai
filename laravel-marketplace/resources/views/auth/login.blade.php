...
@section('title', 'Login - PhoneMarket')
    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Access the Serbian phone marketplace
            </p>
        </div>
        ...
        <form class="mt-8 space-y-6" method="POST" action="{{ route('login') }}" x-data="loginForm()">
                ...
                <div>
                    ...
                    <div class="mt-1 relative">
                        <input id="password" name="password" type="password" required 
                               ...
                               placeholder="Enter your password" autocomplete="current-password" x-model="password" @input="validatePassword()">
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('register') }}" class="font-medium text-primary-600 hover:text-primary-500">Create one here</a>
                </p>
            </div>
        </form>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>Your account needs verification to access all features:</p>
