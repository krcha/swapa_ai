...
@section('title', 'Add Phone Model')
@section('page-title', 'Add Phone Model')
...
<nav class="hidden sm:flex" aria-label="Breadcrumb">
    <ol class="flex items-center space-x-2">
        ...
        <li>
            <div class="flex items-center">
                <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                <span class="text-sm font-medium text-gray-900">Add Model</span>
            </div>
        </li>
    </ol>
</nav>
...
<div class="space-y-8 admin-content">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Add a new approved phone model to the system</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
        ...
        <form action="{{ route('admin.approved-models.store') }}" method="POST">
            @csrf
